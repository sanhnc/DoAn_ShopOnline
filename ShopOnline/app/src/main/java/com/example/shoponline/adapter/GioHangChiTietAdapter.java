...
public class GioHangChiTietAdapter extends BaseAdapter {

    private Activity context;
    private List<GioHang> gioHangList;

    public GioHangChiTietAdapter(Activity context, List<GioHang> gioHangList) {
    ...
    public void loadFragmentUI(){
        ...
        Intent t = new Intent(context, DatHangActivity.class);
